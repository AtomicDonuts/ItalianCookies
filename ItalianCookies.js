ItalianCookies = 
{
    ...
    newupgrades:function(){ 
        ...
        Game.NewUpgradeCookie({name:'Dropplet'          ,desc:'Why limit yourself to circular cookies.'             ,icon:[4,0,ItalianCookies.piconURL]  ,power:3,	price:	ItalianCookies.cookieprice*10000    ,require: "Box of Italian Cookies"});Game.last.order = 10030 + 0.001 * Game.last.id; ItalianCookies.CookiesUpgradeMade.push(Game.last)ItalianCookies = 
{
    modname: "Italian Cookies",
    //savecheck: false,
    init:function(){
